...
class AppStore extends Component {
  ...
  render() {
    ...
    const searchFilterApps = filteredApps.filter(eachObj =>
    ...
    return (
      <div className="App-background">
        <div className="App-top-content">
          <h1 className="app-main">App Store</h1>
          ...
          <div className="tabItem">
            <ul>
              {tabsList.map(tabsItem => (
                <TabItem
                  activeStatus={activeTabId === tabsItem.tabId}
                  tabChange={this.tabSwitch}
                  tabsItem={tabsItem}
                  key={tabsItem.tabId}
                />
              ))}
